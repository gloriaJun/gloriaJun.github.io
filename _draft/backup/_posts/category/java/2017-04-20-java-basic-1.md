...
![]({{ site.url }}/assets/images/post/2017/0420-primitive-type.png)

###### Reference Type
primitive를 제외한 나머지 타입으로 *null 또는 객체의 주소*를 값으로 갖음.

## Type Casting
![]({{ site.url }}/assets/images/post/2017/0420-type-casting.png)
왼쪽에서 오른쪽으로의 변환은 캐스트 연산자를 사용하지 않아도 자동으로 형변환이 일어난다.
하지만 반대 방향의 경우, 형변환시 값의 손실이 발생할 수 있으므로 변환시 반드시 캐스트 연산자를 사용하여야 한다.

## 연산자
![]({{ site.url }}/assets/images/post/2017/0420-logical.png)
...
![]({{ site.url }}/assets/images/post/2017/0420-operator.png)
...
![]({{ site.url }}/assets/images/post/2017/0420-operator2.png)
