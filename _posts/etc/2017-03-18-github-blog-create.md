---
layout: post
title: "(github blog) 블로그 만들기 for mac"
...
![]({{ site.baseurl }}/assets/images/post/2017/0318-blog-create-repo.png)
...
> 만약, 해당 명령어 수행 시에 에러가 발생하면 `bundle exec` 키워드를 앞에 붙여서 수행을 해본다

웹브라우저(http://127.0.0.1:4000/)에 접속해보면 다음과 같은 화면이 출력된다.
![]({{ site.baseurl }}/assets/images/post/2017/0318-blog-test-page.png)
...
![]({{ site.baseurl }}/assets/images/post/2017/0318-blog-first-commit.png)
